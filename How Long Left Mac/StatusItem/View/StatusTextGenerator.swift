...
class StatusTextGenerator {
    ...
    func getStatusItemText(for event: Event, at date: Date) -> String {
    ...
    private func createCountdownText(for event: Event, at date: Date) -> String {
    ...
    private func countdown(endDate date: Date, percentageStartDate: Date?, at currentDate: Date, showSeconds: Bool) -> String {
